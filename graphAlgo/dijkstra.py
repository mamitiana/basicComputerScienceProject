...
from search.genericsearch import PriorityQueue
...
def dijkstra( wg: WeightedGraph[V] , root: V) -> Tuple[List[Optional[float]] , Dict[int , WeightedEdge] ] :
    ...
    #distances are unknonw at first
...
# helper funct to get easier access to dijkstra results
