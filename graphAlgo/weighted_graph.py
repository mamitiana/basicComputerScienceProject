...
class WeightedGraph(Generic[V] , Graph[V]):
    ...
    def add_edge_by_indices(self, u: int, v: int , weight:float) -> None:
        ...
        self.add_edge(edge) # for the super class Edge
    ...
    def neighbors_for_index_weights(self, index: int) -> List[ Tuple[V,float] ]:
    ...
    def __str__(self) -> str:
        ...
        for i in range(self.vertex_count):
            desc+= f"{self.vertex_at(i)} ->{self.neighbors_for_index_weights(i)}\n"
        return desc
